 ...
 * |------+------+------+------+------+------+------|   |------+------+------+------+------+------+------|
 * | Alt  | GUI  |  App |Esc/  | 英数 |Space/|Tab/  |   |Back  |Enter/| かな | Del  |=>EUKARIN|=>SYMB|  ¥   |
...
[QWERTY] = KEYMAP( \
  ...
  KC_LALT, KC_LGUI, KC_APP, LT(SYMB, KC_ESC), KC_LANG2, GUI_T(KC_SPC), SFT_T(KC_TAB), KC_BSPC,    LT(META, KC_ENT), KC_LANG1, KC_DELT,  TG(EUKARIN), TG(SYMB), KC_RO \
),
